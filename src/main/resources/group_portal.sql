...
-- Records of m_user
-- ----------------------------
INSERT INTO `admin` VALUES ('1', 'admin','96e79218965eb72c92a549dd5a330112', '0', '2020-04-20 10:44:01', null);

-- ----------------------------
-- Table structure for home_context
-- ----------------------------
DROP TABLE IF EXISTS `home_context`;
...
-- ----------------------------
-- Table structure for research_context
-- ----------------------------
DROP TABLE IF EXISTS `research_context`;
...
-- ----------------------------
-- Table structure for harvest_context
-- ----------------------------
DROP TABLE IF EXISTS `harvest_context`;
CREATE TABLE `harvest_context` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `content` longtext,
  `status` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Table structure for numbers_context
-- ----------------------------
DROP TABLE IF EXISTS `numbers_context`;
CREATE TABLE `numbers_context` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `content` longtext,
  `status` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`id`)
